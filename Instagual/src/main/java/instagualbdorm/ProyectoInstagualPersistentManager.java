...
public class ProyectoInstagualPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoInstagual";
	...
	private ProyectoInstagualPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(instagualbdorm.Usuario.class);
		configuration.addAnnotatedClass(instagualbdorm.Usuario_Registrado.class);
		configuration.addAnnotatedClass(instagualbdorm.Etiqueta.class);
		configuration.addAnnotatedClass(instagualbdorm.Administrador.class);
		configuration.addAnnotatedClass(instagualbdorm.Elemento.class);
		configuration.addAnnotatedClass(instagualbdorm.Comentario.class);
		configuration.addAnnotatedClass(instagualbdorm.Configuracion.class);
		configuration.addAnnotatedClass(instagualbdorm.Publicacion.class);
		configuration.addAnnotatedClass(instagualbdorm.Notificacion.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoInstagualPersistentManager();
		}
